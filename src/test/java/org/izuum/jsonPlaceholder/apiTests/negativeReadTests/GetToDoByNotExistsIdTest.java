...
@DisplayName("TC-056: Запрос ToDo с несуществующим id")
public class GetToDoByNotExistsIdTest {

    @Test
    @DisplayName("TC-056: Статус-код не 5хх")
    public void checkExpectedNotServerError(){
        Response response = getResponse("/todos/9999");

        assertTrue(response.statusCode() < 500);

        System.out.println("TC-056: ======Фиксация контракта======");
        System.out.println("Запрос: GET /todos/9999");
