...
#TC-078 (SendPutRequestWithNotExistsIdTest) содержит баг:
- при отправке PUT-запроса на несуществующий ресурс вызывает 500(Internal Server Error) вместо 404(Not Found)
